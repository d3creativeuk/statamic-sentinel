    ...
    <div x-data="{
        ...
        <div role="status"
            ...
            <div style="display:flex; align-items:center; gap:10px;">
                ...
                <span style="flex:1;"><strong>Notification of planned work:</strong> Statamic maintenance starts <span style="font-variant-numeric:tabular-nums;">{{ $sentinelFreezeAt }}</span></span>
                <button type="button"
                        x-on:click="openModal()"
