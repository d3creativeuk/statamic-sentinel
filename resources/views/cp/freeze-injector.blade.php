        ...
        <dialog x-ref="dlg"
            ...
            <div style="padding:24px 28px;">
                ...
                <p style="font-size:14px; color:#475569; margin:0 0 14px 0; line-height:1.55;">
                    An update to this site is currently in progress, started at <strong style="color:#0f172a; font-variant-numeric:tabular-nums;">{{ $sentinelStartedAt }}</strong>. Please don't edit content until you receive the all-clear email and the banner turns green.
                </p>
            </div>
    ...
    <div x-data="{
        ...
        <div role="status"
            ...
            <div style="display:flex; align-items:center; gap:10px;">
                ...
                <span style="flex:1;"><strong>A Statamic update is scheduled for {{ $sentinelHost }}.</strong> Statamic maintenance starts <span style="font-variant-numeric:tabular-nums;">{{ $sentinelFreezeAt }}</span>.</span>
                <button type="button"
                        x-on:click="openModal()"
